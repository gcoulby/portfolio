...
const experienceItems: IExperienceItem[] = [
  {
    ...
    endYear: 'PRESENT',
    description:
      'In this role I develop hardware, software and cloud development operations for bringing AI innovations to maritime transportation. I am currently developing solutions to increase maritime fleet availability, cut carbon emissions and reduce operational risk across shipping fleets around the globe. In this role I have developed bespoke hardware and software solutions from the ground up to capture live data from vessels and provide real-time insights to fleet operators. I have also developed software right across the tech stack - from embedded systems to cloud-based analytics.',
  },
  {
